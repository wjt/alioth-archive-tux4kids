<?php include ('includes/pageheader.php');?>
	<title>Tux4kids &raquo; Tuxtype &raquo; Home</title>
	</head>
<body>
	<div  align="center">
		<div class="box">
			...
			<div class="col2">
				...
				<table class="front">
					<tr>
						<th>NEWS, 2009-03-14: New releases of TuxType</th>
					</tr>
					<tr>
						<td>
						Tux Typing 1.7.4 are available for download on our File Releases page as source tarballs
						and Win32 installer builds. RPM packages for most GNU/Linux distributions can be found via this search page . For Mac users,
						the new packages should be in MacPorts shortly, and dmg files will be posted here when built. These releases mostly reflect
						underlying code cleanup in advance of this year\'s Google Summer of Code, with only minor user-visible changes.
						</td>
					</tr>
				</table>
				<br />
